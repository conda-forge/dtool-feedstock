...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dtool-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dtool-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `dtool` available on your platform:
...
```
mamba search dtool --channel conda-forge
```
...
```
pixi search dtool --channel conda-forge
```
...
mamba repoquery search dtool --channel conda-forge

# List packages depending on `dtool`:
mamba repoquery whoneeds dtool --channel conda-forge

# List dependencies of `dtool`:
mamba repoquery depends dtool --channel conda-forge
```
