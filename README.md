...
Once the `conda-forge` channel has been enabled, `dtool` can be installed with `conda`:
...
It is possible to list all of the versions of `dtool` available on your platform with `conda`:
